@extends('layouts.principal')
   ...
   @include('services.index')
    ...
    <div class="section-title text-center about-PhysiotherapyPro-top">
            <div class="parallax-section-divider">
                <div class="container pt-0">
                    <p>
                         ¿Necesitas una<span class="color-text"> Cita</span>? Con gusto te la brindamos.
                    </p>
    ...
    <!-- Features -->
    <section id="features">
        <div class="features-1 bg-alternative">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-lg-6 col-md-6 col-sm-6">
                        <h3 class="uppercase">Highly Qualified Team</h3>
                        <div class="vs-20"></div>
                        <p>
                            Praesent fringilla congue eros ut porttitor. Fusce vel metus vel diam varius pellentesque. In eget laoreet neque.
                            Praesent fringilla congue eros ut porttitor. Fusce vel metus vel diam varius pellentesque. In eget laoreet neque.
                        </p>
                        <p>
                            Praesent fringilla congue eros ut porttitor. Fusce vel metus vel diam varius pellentesque. In eget laoreet neque.
                        ...
                        <div class="vs-40"></div>
                        <a class="btn btn-normal">Read More...</a>
                    </div>
                            ...
                            <div class="team-member-img">
                                <figure class="image-overlay">
                                    <div class="hover-image-wrapper">
                                        ...
                                        <img src="assets/img/people/smile-1.jpg" class="img-responsive" alt='people1' />
                                    </div>
                                </figure>
                            ...
                            <div class="team-member-img">
                                <figure class="image-overlay">
                                    <div class="hover-image-wrapper">
                                        ...
                                        <img src="assets/img/people/smile-2.jpg" class="img-responsive" alt='people2' />
                                    </div>
                                </figure>
                            </div>
                            <div class="team-member-details bg-blue text-center">
                            ...
                            <div class="team-member-img">
                                <figure class="image-overlay">
                                    <div class="hover-image-wrapper">
                                        ...
                                        <img src="assets/img/people/smile-3.jpg" class="img-responsive" alt='people3' />
                                    </div>
                                </figure>
                            </div>
                            <div class="team-member-details bg-blue text-center">
                            ...
                            <div class="team-member-img">
                                <figure class="image-overlay">
                                    <div class="hover-image-wrapper">
                                        ...
                                        <img src="assets/img/people/smile-4.jpg" class="img-responsive" alt='people4' />
                                    </div>
                                </figure>
                            </div>
                            <div class="team-member-details bg-blue text-center">
        ...
        <div class="features-2  bg-alternative">
            <div class="container">
                <div class="row">

                    <div class="col-xs-12 col-lg-6 col-md-6 col-sm-6">
                        <h3 class="uppercase">EXPERT TREATMENT</h3>
                        <div class="vs-20"></div>
                        <p>
                            Praesent fringilla congue eros ut porttitor. Fusce vel metus vel diam varius pellentesque. In eget laoreet neque.
                            Praesent fringilla congue eros ut porttitor. Fusce vel metus vel diam varius pellentesque. In eget laoreet neque.
    ...
    <!-- End Features -->
    <!-- Video -->
    <section id="full-screen-video" class="video-section">
        <div class="pattern-overlay">
            ...
            <div class="container tbl">
                <div class="tbl-cell">
                    ...
                    <p>Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Nullam id dolor id nibh ultricies vehicula ut id elit.Praesent commodo cursus magna. Donec sed odio dui.</p>
                </div>
            </div>
            <!-- End Video Background Text-->
        </div>
        <!-- Video Background -->
        <a class="player" data-property="{videoURL:'FL_JxUvIdSo',containment:'.video-section', quality:'hd720', autoPlay:true, mute:true, opacity:1}">bg</a>
